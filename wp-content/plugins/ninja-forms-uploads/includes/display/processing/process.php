		...
		foreach( $tmp_upload_file as $key => $file ){
			if( ( isset( $file['complete'] ) AND $file['complete'] == 0 ) OR !isset( $file['complete'] ) ){
				if( isset( $file['file_path'] ) ){
					$file_path = str_replace(array("/var/www/innovationgym", "/htdocs"), array("/var/www/vhosts/innovationgym.org", "/httpdocs"), $file['file_path']);
				}else{
					$file_path = '';
				}
				...
				if($file_path != ''){
					...
					$file_dir = str_replace(array("/var/www/innovationgym", "/htdocs"), array("/var/www/vhosts/innovationgym.org", "/httpdocs"), $upload_dir.$file_name);
